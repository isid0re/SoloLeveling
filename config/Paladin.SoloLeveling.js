...
function LoadConfig () {
	...
	if (me.gametype === 1) { //LOD game gear
		...
		if (Item.getEquippedItem(5).tier < 18) { // Sanctuary
			if (!haveItem("shield", "runeword", "Sanctuary")) {
				var Sanctuary = [
					...
					"[Name] == MalRune",
					"([Name] == AkaranTarge || [Name] == AkaranRondache || [Name] == GildedShield ||[Name] == ProtectorShield || [Name] == SacredTarge) && [Flag] != Ethereal && [Quality] >= Normal && [Quality] <= Superior # [fireresist] > 0 && [Sockets] == 3 # [MaxQuantity] == 1",
				];
				NTIP.arrayLooping(Sanctuary);

				if (me.diff === 2) {
					NTIP.addLine("([Name] == AkaranTarge || [Name] == AkaranRondache || [Name] == GildedShield ||[Name] == ProtectorShield || [Name] == SacredTarge) && [Quality] == Normal # [fireresist] > 20 && [Sockets] == 0 # [MaxQuantity] == 1");
		...
		if (me.ladder > 0) { // Ladder runewords - Spirit Sword/Shield & Insight
			...
			if (Item.getEquippedItem(5).tier < 26) { // Spirit shield
				var SpiritShield = [
					"[Name] == TalRune # # [MaxQuantity] == 1",
					"[Name] == ThulRune # # [MaxQuantity] == 1",
					"[Name] == OrtRune # # [MaxQuantity] == 1",
	...
	var autoequipTiers = [ // autoequip setup
		...
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 0 # [tier] == 21",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 5 # [tier] == 22",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 10 # [tier] == 23",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 15 # [tier] == 24",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 20 # [tier] == 25",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 25 # [tier] == 26",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 30 # [tier] == 27",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 35 # [tier] == 28",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 40 # [tier] == 29",
		"[Name] == sallet && [quality] == unique && [flag] != ethereal # [enhanceddefense] >= 160 # [tier] == 30", // rockstopper
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 0 # [tier] == 31",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 5 # [tier] == 32",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 10 # [tier] == 33",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 15 # [tier] == 34",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 20 # [tier] == 35",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 25 # [tier] == 36",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 30 # [tier] == 37",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 35 # [tier] == 38",
		"([type] == helm || [type] == circlet) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 40 && [maxhp] >= 40 # [tier] == 39",
		...
		"([type] == shield || [type] == auricshields) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && ([fireresist]+[lightresist]+[coldresist]) >= 45 # [tier] == 10",
		...
		"([type] == shield || [type] == auricshields) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 45 # [tier] == 14",
		"([type] == shield || [type] == auricshields) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 50 # [tier] == 15",
		"([type] == shield || [type] == auricshields) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 55 # [tier] == 16",
		"([type] == shield || [type] == auricshields) && [flag] != ethereal # [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 2 && ([fireresist]+[lightresist]+[coldresist]) >= 60 # [tier] == 17",
		...
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 # [tier] == 19", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 10 # [tier] == 20", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 15 # [tier] == 21", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 20 # [tier] == 22", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 25 # [tier] == 23", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 30 # [tier] == 24", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 35 # [tier] == 25", // spirit
		"([type] == shield || [type] == auricshields) && [flag] != ethereal && [flag] == runeword  # [fcr] >= 25 && [maxmana] >= 89 && [fireresist] >= 40 # [tier] == 26", // spirit
		//gloves
		...
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 20 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] == 1 # [Tier] == 12",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 25 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] == 1 # [Tier] == 13",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 0 # [Tier] == 14",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 5 # [Tier] == 15",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 10 # [Tier] == 16",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 15 # [Tier] == 17",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 20 && [strength] >= 0 # [Tier] == 18",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 20 && [strength] >= 5 # [Tier] == 19",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 20 && [strength] >= 10 # [Tier] == 20",
		"[Type] == Amulet && [Quality] == Rare # [FireResist]+[LightResist] >= 30 && [ItemAllSkills]+[PaladinSkills]+[PaliCombatSkillTab] >= 1 && [maxhp] >= 20 && [strength] >= 15 # [Tier] == 21",
		//rings
