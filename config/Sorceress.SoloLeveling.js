...
function LoadConfig () {
	...
	Config.StaticList = ["Mephisto", "Izual", "Lord De Seis", "Diablo", "Colenzo the Annihilator", "Achmel the Cursed", "Bartuc the Bloody", "Ventar the Unholy", "Lister the Tormentor", "Baal"];
