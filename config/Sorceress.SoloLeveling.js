...
function LoadConfig () {
	...
	var tiers = [
		...
		//armor
		"[type] == armor && [flag] == runeword # [fireresist] == 50 # [tier] == 5",
		"[name] == serpentskinarmor && [quality] == unique && [flag] != ethereal # [fireresist] >= 30 # [tier] == 6",
	...
	if (Item.getEquippedItem(4).tier < 3) {// Leaf
		var leaf = [
